/**
 * Rate limiting logic for the HaloPSA API
 *
 * HaloPSA enforces:
 * - 500 requests per 3-minute (180 second) rolling window
 * - At 400 requests (80%), we start proactive throttling
 * - At 500+ requests, returns 429 Too Many Requests
 */
